...
describe("GET /companies", function () {
  ...
  test("works: filtering with minEmployees", async function () {
    const resp = await request(app)
      .get("/companies")
  ...
  test("works: filtering with maxEmployees", async function () {
    const resp = await request(app)
      .get("/companies")
  ...
  test("works: filtering with name", async function () {
    const resp = await request(app).get("/companies").query({ nameLike: "3" });
    expect(resp.body).toEqual({
      companies: [
        {
          handle: "c3",
